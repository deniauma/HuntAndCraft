...
var $author$project$Battle$FightingStats = F4(
	function (hp, max_hp, atk, def) {
		return {R: atk, aG: def, t: hp, aj: max_hp};
	});
var $author$project$Game$Idle = 2;
var $author$project$Battle$NoBattle = {$: 0};
var $author$project$Explo$NoExplo = {$: 0};
var $author$project$Inventory$Inventory = F2(
	function (next_id, equips) {
		return {z: equips, U: next_id};
	});
var $author$project$Equip$Equip = F4(
	function (kind, name, stats, equipped) {
		return {aJ: equipped, aQ: kind, aR: name, aW: stats};
	});
var $author$project$Equip$Head = 1;
var $author$project$Equip$createHelmet = F2(
	function (name, stats) {
		return A4($author$project$Equip$Equip, 1, name, stats, false);
	});
...
var $author$project$Inventory$newForTest = A2(
	...
	$elm$core$Dict$fromList(
		_List_fromArray(
			[
				...
				0,
				A2(
					$author$project$Equip$createHelmet,
					'Helmet (test)',
					A4($author$project$Battle$FightingStats, 10, 10, 0, 5))),
				_Utils_Tuple2(
				1,
				A2(
					$author$project$Equip$createHelmet,
	...
	return _Utils_Tuple2(
		{
			...
			S: $author$project$Inventory$newForTest,
			n: 2,
			Q: A4($author$project$Battle$FightingStats, 300, 300, 10, 0),
			w: _List_Nil
		},
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {V: oldTime, au: request, aw: subs};
	});
...
var $author$project$Explo$Quest = F5(
	function (monster_type, biome, remaining, exp, gold) {
		return {K: biome, aK: exp, aM: gold, k: monster_type, F: remaining};
	});
...
var $author$project$Explo$createQuestFromZone = function (zone) {
	...
	if (!_v0) {
		return A2(
			$elm$random$Random$map,
			function (x) {
				return A5($author$project$Explo$Quest, x, zone.K, 1, 10, 50);
			},
			A2(
...
var $author$project$Explo$Zone = F3(
	function (name, biome, explo_rate) {
		return {K: biome, ae: explo_rate, aR: name};
	});
...
var $author$project$Battle$MonsterTurn = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
var $author$project$Battle$Win = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
var $elm$core$Basics$ge = _Utils_ge;
var $author$project$Battle$updateFighterHP = F2(
	function (attacker, defender) {
		return _Utils_update(
			defender,
			{
				t: A2($elm$core$Basics$max, defender.t - attacker.R, 0)
			});
	});
				...
				case 1:
					...
					if (acc >= 500) {
						var new_monster = _Utils_update(
							monster,
							{
								t: A2($elm$core$Basics$max, monster.t - player.R, 0)
							});
						if (!new_monster.t) {
							...
							battle = $temp$battle;
							acc = $temp$acc;
							continue updateBattle;
						} else {
							var $temp$battle = A2($author$project$Battle$MonsterTurn, player, new_monster),
								$temp$acc = acc - 500;
							battle = $temp$battle;
							acc = $temp$acc;
							continue updateBattle;
						...
						return _Utils_Tuple2(battle, acc);
					}
				case 2:
					var player = battle.a;
					var monster = battle.b;
					if (acc >= 500) {
						...
						if (!new_player.t) {
							...
							var $temp$battle = A2($author$project$Battle$PlayerTurn, new_player, monster),
								$temp$acc = acc - 500;
							battle = $temp$battle;
							acc = $temp$acc;
							continue updateBattle;
...
var $author$project$Explo$updateExplo = F2(
	function (explo, acc) {
		updateExplo:
		while (true) {
			switch (explo.$) {
				...
				case 1:
					...
					if (_Utils_cmp(acc, $author$project$Explo$exploTick) > -1) {
						var new_progress = A2($elm$core$Basics$min, progress + zone.ae, 100);
						if (new_progress === 100) {
							return _Utils_Tuple2(
							...
							var $temp$explo = A2($author$project$Explo$ExploInProgress, zone, new_progress),
								$temp$acc = acc - $author$project$Explo$exploTick;
							explo = $temp$explo;
							acc = $temp$acc;
							continue updateExplo;
						}
					} else {
						return _Utils_Tuple2(explo, acc);
					}
				default:
					var zone = explo.a;
					return _Utils_Tuple2(explo, 0);
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				...
				switch (_v1) {
					case 0:
						var _v2 = A2($author$project$Explo$updateExplo, model.o, model.s + delta);
						var new_explo = _v2.a;
						...
						if (new_explo.$ === 2) {
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{s: new_explo_acc, o: new_explo}),
								$elm$core$Platform$Cmd$none);
						}
					case 1:
						var _v4 = A2($author$project$Battle$updateBattle, model.g, model.I + delta);
						var new_battle = _v4.a;
						var new_battle_acc = _v4.b;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{I: new_battle_acc, g: new_battle}),
							$elm$core$Platform$Cmd$none);
					default:
			...
			case 3:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							g: A2($author$project$Battle$PlayerTurn, model.Q, monster_stats),
							o: $author$project$Explo$NoExplo,
							n: 1,
							w: new_quests
						}),
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							o: A2(
								$author$project$Explo$ExploInProgress,
								$author$project$Explo$getZonefromBiome(q.K),
								0),
...
var $author$project$Game$viewBattleButtons = F2(
	function (battle_state, player_action) {
		switch (battle_state.$) {
			case 0:
				return A2(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$disabled(player_action !== 2)
						]),
					_List_fromArray(
						[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(m.t) + ('/' + $elm$core$String$fromInt(m.aj)))
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									'width',
									$elm$core$String$fromFloat((m.t / m.aj) * 100) + '%')
								]),
							_List_Nil)
						]))
				]));
...
var $author$project$Game$viewPlayerStats = F2(
	function (player, battle_state) {
		var current_hp = function () {
			switch (battle_state.$) {
				case 1:
		...
		var hp_percent = $elm$core$String$fromFloat((current_hp / player.aj) * 100) + '%';
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Game$viewBattleOutcome(battle_state)
						])),
					A2(
					$elm$html$Html$span,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(current_hp) + ('/' + $elm$core$String$fromInt(player.aj)))
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
...
var $author$project$Game$viewBattle = F2(
	function (model, player_action) {
		var _v0 = model.y;
		if (_v0.$ === 1) {
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($author$project$Game$viewPlayerStats, model.Q, model.g),
...
var $author$project$Inventory$getAllEquips = function (inventory) {
	return $elm$core$Dict$toList(inventory.z);
};
var $author$project$Game$viewEquip = function (_v0) {
	var eq_id = _v0.a;
	var equip = _v0.b;
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
				...
				$elm$core$String$fromInt(eq_id))
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(equip.aR)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$text(
				'battle acc: ' + $elm$core$String$fromFloat(model.I)),
				$elm$html$Html$text(
				...
				A2(
					$elm$core$List$map,
					$author$project$Game$viewEquip,
					$author$project$Inventory$getAllEquips(model.S)))
			]));
};
var $elm$html$Html$option = _VirtualDom_node('option');
var $elm$html$Html$select = _VirtualDom_node('select');
var $author$project$Game$viewEquipment = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('equips')
		]),
	_List_fromArray(
		[
			A2(
		...
		switch (explo.$) {
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Events$onClick($author$project$Game$CancelExplo)
										]),
									_List_fromArray(
										[
			...
			case 0:
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('No exploration in progress.'),
							A2($elm$html$Html$br, _List_Nil, _List_Nil),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($author$project$Game$StartExplo),
									$elm$html$Html$Attributes$disabled(player_action !== 2)
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Start exploring')
								]))
						]));
			default:
				var zone = explo.a;
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Exploration of ' + (zone.aR + ' is complete.'))
						]));
		}
	});
...
var $author$project$Game$viewQuest = function (q) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('quest-item'),
				$elm$html$Html$Events$onClick(
				$author$project$Game$SelectQuest(q))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Experience: ' + $elm$core$String$fromInt(q.aK))
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Gold: ' + $elm$core$String$fromInt(q.aM))
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Remaining: ' + $elm$core$String$fromInt(q.F))
					])),
				A2($elm$html$Html$br, _List_Nil, _List_Nil)
			]));
};
var $author$project$Game$viewQuests = function (quests) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Game$viewQuest, quests));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('quests')
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('explo')
					]),
				_List_fromArray(
					[
						A2(
						...
						A2($author$project$Game$viewExploration, model.o, model.n)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('battle')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Battle')
							])),
						A2($author$project$Game$viewBattle, model, model.n)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('gear')
					]),
				_List_fromArray(
					[
						A2(
						...
						$author$project$Game$viewEquipment
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$author$project$Game$viewDebug(model)
					]))
			]));
};
var $author$project$Game$main = $elm$browser$Browser$element(
	{aP: $author$project$Game$init, aX: $author$project$Game$subscriptions, aZ: $author$project$Game$update, a_: $author$project$Game$view});
